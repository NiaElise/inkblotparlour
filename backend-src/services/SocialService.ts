...
export class SocialService {
  static createPost(userId: string, id: string, content: string, storyworldId?: string): void {
    DB.execute(`INSERT INTO posts (id, user_id, storyworld_id, content) VALUES ('${id}', '${userId}', ${storyworldId ? `'${storyworldId}'` : 'NULL'}, '${content}')`);
  }
  ...
  static answerAsk(askId: string, answer: string, isPublic: boolean): void {
